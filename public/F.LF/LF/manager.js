  ...
  function (global, network, Soundpack, Match, util, Touchcontroller, Random,
    ...
    function Manager(pack, buildinfo) {
      ...
      this.create = function () {
       var path = 'core/css!' + pack.path + 'UI/UI.css';
console.log('路径:', path);
require([path], function () {
  // 你的代码逻辑
        ...
        settings =
        {
          ...
          server:
          {
            'Project F 官方服务器': 'http://lobby.projectf.hk'
          },
          support_sound: false
        }
        ...
        settings.control[0].config= { 'att': "j"
                                      ,'def': "l"
                                      ,'down': "s"
                                      ,'jump': "k"
                                      ,'left': "a"
